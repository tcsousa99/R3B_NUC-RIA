...
/opt/fairsoft/bin/rootcint -f /work/R3BRoot/build/fi0/G__R3BFi0Dict.cxx -rmf /work/R3BRoot/build/lib/libR3BFi0.rootmap -rml R3BFi0.so  -inlineInputHeader -c   -I/work/R3BRoot/fi0 -I/work/R3BRoot/fiber -I/work/R3BRoot/r3bbase -I/work/R3BRoot/r3bdata -I/work/R3BRoot/r3bdata/fibData -I/work/R3BRoot/tcal -I/opt/fairsoft/include/root6 -I/opt/fairsoft/include -I/opt/fairroot/include R3BFi0Cal2Hit.h R3BFi0Mapped2Cal.h Fi0LinkDef.h
