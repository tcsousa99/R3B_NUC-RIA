...
/opt/fairsoft/bin/rootcint -f /work/R3BRoot/build/fi8/G__R3BFi8Dict.cxx -rmf /work/R3BRoot/build/lib/libR3BFi8.rootmap -rml R3BFi8.so  -inlineInputHeader -c   -I/work/R3BRoot/fi8 -I/work/R3BRoot/fiber -I/work/R3BRoot/r3bbase -I/work/R3BRoot/r3bdata -I/work/R3BRoot/r3bdata/fibData -I/work/R3BRoot/tcal -I/work/R3BRoot/tracking -I/opt/fairsoft/include/root6 -I/opt/fairsoft/include -I/opt/fairroot/include R3BFi8.h R3BFi8Cal2Hit.h R3BFi8Mapped2Cal.h R3BFi8ContFact.h Fi8LinkDef.h
