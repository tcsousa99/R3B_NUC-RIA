...
/opt/fairsoft/bin/rootcint -f /work/R3BRoot/build/fi1a/G__R3BFi1aDict.cxx -rmf /work/R3BRoot/build/lib/libR3BFi1a.rootmap -rml R3BFi1a.so  -inlineInputHeader -c   -I/work/R3BRoot/fi1a -I/work/R3BRoot/fiber -I/work/R3BRoot/r3bbase -I/work/R3BRoot/r3bdata -I/work/R3BRoot/r3bdata/fibData -I/work/R3BRoot/tcal -I/opt/fairsoft/include/root6 -I/opt/fairsoft/include -I/opt/fairroot/include R3BFi1aCal2Hit.h R3BFi1aMapped2Cal.h Fi1aLinkDef.h
