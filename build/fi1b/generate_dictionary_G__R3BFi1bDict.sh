...
/opt/fairsoft/bin/rootcint -f /work/R3BRoot/build/fi1b/G__R3BFi1bDict.cxx -rmf /work/R3BRoot/build/lib/libR3BFi1b.rootmap -rml R3BFi1b.so  -inlineInputHeader -c   -I/work/R3BRoot/fi1b -I/work/R3BRoot/fiber -I/work/R3BRoot/r3bbase -I/work/R3BRoot/r3bdata -I/work/R3BRoot/r3bdata/fibData -I/work/R3BRoot/tcal -I/opt/fairsoft/include/root6 -I/opt/fairsoft/include -I/opt/fairroot/include R3BFi1bCal2Hit.h R3BFi1bMapped2Cal.h Fi1bLinkDef.h
