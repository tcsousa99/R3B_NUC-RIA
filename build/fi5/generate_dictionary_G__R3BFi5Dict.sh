...
/opt/fairsoft/bin/rootcint -f /work/R3BRoot/build/fi5/G__R3BFi5Dict.cxx -rmf /work/R3BRoot/build/lib/libR3BFi5.rootmap -rml R3BFi5.so  -inlineInputHeader -c   -I/work/R3BRoot/fi5 -I/work/R3BRoot/fiber -I/work/R3BRoot/r3bbase -I/work/R3BRoot/r3bdata -I/work/R3BRoot/r3bdata/fibData -I/work/R3BRoot/tcal -I/work/R3BRoot/tracking -I/opt/fairsoft/include/root6 -I/opt/fairsoft/include -I/opt/fairroot/include R3BFi5.h R3BFi5Cal2Hit.h R3BFi5Mapped2Cal.h R3BFi5ContFact.h Fi5LinkDef.h
