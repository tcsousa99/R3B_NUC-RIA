...
// -----   Default constructor   -------------------------------------------
EnsarHPGeDet::EnsarHPGeDet() : R3BDetector("EnsarHPGeDet", kTRUE, kHPGE) //changed from "EnsarDetector" to R3BDetector
{
  ResetParameters();
...
EnsarHPGeDet::EnsarHPGeDet(const TString& geoFile, Bool_t active)
    : R3BDetector(geoFile, active, kHPGE) //changed from "EnsarDetector" to R3BDetector
{
  ResetParameters();
  fPointCollection = new TClonesArray("EnsarHPGeDetPoint");
  fHitCollection = new TClonesArray("EnsarHPGeDetHit");
